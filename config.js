...
if (!(process.env.SESSION || process.env.SESSION_ID)) throw new Error("add session id, no session id found")
module.exports = {
    VERSION: 'v4.0.0',
    ALIVE: process.env.ALIVE || "https://i.imgur.com/KCnoMM2.jpg Hey {sender}, lemme is active \n Uptime: {uptime}",
    ...
    ANTI_SPAM: process.env.ANTI_SPAM || '2349074249281-1632403322@g.us',
    ...
    SESSION: (process.env.SESSION || process.env.SESSION_ID || 'Raganork~4e367253b8bde8854756340ae943992a:764b4e472f4342677345303d').trim() || '',
